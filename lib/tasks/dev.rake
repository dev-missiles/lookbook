...
task({ :sample_data => :environment}) do
  ...
  users = [
    {id: 91, email: "lucy@example.com", first_name: "Lucy", last_name: "Brown", image: "fakelucyimage123", cohort_id: 1, created_at: "2015-05-10 02:20:15", updated_at: "2019-11-01 12:10:00", quote: "Something to fill space", resume_link: "http://example.com/new_resume.pdf", fun_fact: 'I once swam with sharks'},
    {id: 97, email: "kevin@example.com", first_name: "Kevin", last_name: "Johnson", image: "fakekevinimage456", cohort_id: 2, created_at: "2015-05-15 03:20:45", updated_at: "2019-11-03 14:05:00", quote: "Something to fill space", resume_link: "http://example.com/new_resume.pdf", fun_fact: 'I once swam with sharks'},
    {id: 100, email: "emma@example.com", first_name: "Emma", last_name: "Miller", image: "fakeemmaimage789", cohort_id: 1, created_at: "2015-05-20 04:30:30", updated_at: "2019-11-05 16:20:00", quote: "Something to fill space", resume_link: "http://example.com/new_resume.pdf", fun_fact: 'I once swam with sharks'},
    {id: 103, email: "mike@example.com", first_name: "Mike", last_name: "Davis", image: "fakemikeimage012", cohort_id: 2, created_at: "2015-05-22 05:40:40", updated_at: "2019-11-07 18:30:00", quote: "Something to fill space", resume_link: "http://example.com/new_resume.pdf", fun_fact: 'I once swam with sharks'},
    {id: 106, email: "olivia@example.com", first_name: "Olivia", last_name: "Garcia", image: "fakeoliviaimage345", cohort_id: 1, created_at: "2015-05-27 06:50:50", updated_at: "2019-11-10 20:40:00", quote: "Something to fill space", resume_link: "http://example.com/new_resume.pdf", fun_fact: 'I once swam with sharks'},
    {id: 110, email: "liam@example.com", first_name: "Liam", last_name: "Rodriguez", image: "fakeliamimage678", cohort_id: 2, created_at: "2015-05-30 07:00:00", updated_at: "2019-11-12 22:50:00", quote: "Something to fill space", resume_link: "http://example.com/new_resume.pdf", fun_fact: 'I once swam with sharks'},
    {id: 112, email: "sophia@example.com", first_name: "Sophia", last_name: "Wilson", image: "fakesophiaimage901", cohort_id: 1, created_at: "2015-06-02 08:10:10", updated_at: "2019-11-15 01:30:00", quote: "Something to fill space", resume_link: "http://example.com/new_resume.pdf", fun_fact: 'I once swam with sharks'},
    {id: 117, email: "noah@example.com", first_name: "Noah", last_name: "Peterson", image: "fakenoahimage234", cohort_id: 2, created_at: "2015-06-05 09:20:20", updated_at: "2019-11-17 03:40:00", quote: "Something to fill space", resume_link: "http://example.com/new_resume.pdf", fun_fact: 'I once swam with sharks'},
    {id: 119, email: "mia@example.com", first_name: "Mia", last_name: "Taylor", image: "fakemiaimage567", cohort_id: 1, created_at: "2015-06-07 10:30:30", updated_at: "2019-11-19 05:50:00", quote: "Something to fill space", resume_link: "http://example.com/new_resume.pdf", fun_fact: 'I once swam with sharks'},
    {id: 125, email: "ben@example.com", first_name: "Ben", last_name: "Moore", image: "fakebenimage891", cohort_id: 2, created_at: "2015-06-10 11:40:40", updated_at: "2019-11-21 07:00:00", quote: "Something to fill space", resume_link: "http://example.com/new_resume.pdf", fun_fact: 'I once swam with sharks'},
    {id: 129, email: "ava@example.com", first_name: "Ava", last_name: "Martinez", image: "fakeavaimage213", cohort_id: 1, created_at: "2015-06-14 12:50:50", updated_at: "2019-11-23 09:10:00", quote: "Something to fill space", resume_link: "http://example.com/new_resume.pdf", fun_fact: 'I once swam with sharks'},
    {id: 134, email: "jack@example.com", first_name: "Jack", last_name: "Anderson", image: "fakejackimage546", cohort_id: 2, created_at: "2015-06-17 13:00:00", updated_at: "2019-11-25 11:20:00", quote: "Something to fill space", resume_link: "http://example.com/new_resume.pdf", fun_fact: 'I once swam with sharks'},
    {id: 138, email: "isabella@example.com", first_name: "Isabella", last_name: "Thomas", image: "fakeisabellaimage879", cohort_id: 1, created_at: "2015-06-20 14:10:10", updated_at: "2019-11-27 13:30:00", quote: "Something to fill space", resume_link: "http://example.com/new_resume.pdf", fun_fact: 'I once swam with sharks'},
    {id: 142, email: "aiden@example.com", first_name: "Aiden", last_name: "Jackson", image: "fakeaidenimage012", cohort_id: 2, created_at: "2015-06-22 15:20:20", updated_at: "2019-11-29 15:40:00", quote: "Something to fill space", resume_link: "http://example.com/new_resume.pdf", fun_fact: 'I once swam with sharks'},
    {id: 148, email: "sophie@example.com", first_name: "Sophie", last_name: "White", image: "fakesophieimage345", cohort_id: 1, created_at: "2015-06-26 16:30:30", updated_at: "2019-12-01 17:50:00", quote: "Something to fill space", resume_link: "http://example.com/new_resume.pdf", fun_fact: 'I once swam with sharks'},
    {id: 152, email: "grayson@example.com", first_name: "Grayson", last_name: "Harris", image: "fakegraysonimage678", cohort_id: 2, created_at: "2015-06-29 17:40:40", updated_at: "2019-12-03 19:00:00", quote: "Something to fill space", resume_link: "http://example.com/new_resume.pdf", fun_fact: 'I once swam with sharks'},
    {id: 157, email: "lily@example.com", first_name: "Lily", last_name: "Clark", image: "fakelilyimage901", cohort_id: 1, created_at: "2015-07-02 18:50:50", updated_at: "2019-12-05 21:10:00", quote: "Something to fill space", resume_link: "http://example.com/new_resume.pdf", fun_fact: 'I once swam with sharks'},
    {id: 161, email: "leo@example.com", first_name: "Leo", last_name: "Lewis", image: "fakeleoimage234", cohort_id: 2, created_at: "2015-07-06 20:00:00", updated_at: "2019-12-07 23:20:00", quote: "Something to fill space", resume_link: "http://example.com/new_resume.pdf", fun_fact: 'I once swam with sharks'},
    {id: 165, email: "zoe@example.com", first_name: "Zoe", last_name: "Lee", image: "fakezoeimage567", cohort_id: 1, created_at: "2015-07-10 21:10:10", updated_at: "2019-12-10 01:30:00", quote: "Something to fill space", resume_link: "http://example.com/new_resume.pdf", fun_fact: 'I once swam with sharks'},
    {id: 170, email: "ethan@example.com", first_name: "Ethan", last_name: "Walker", image: "fakeethanimage891", cohort_id: 2, created_at: "2015-07-14 22:20:20", updated_at: "2019-12-12 03:40:00" , quote: "Something to fill space", resume_link: "http://example.com/new_resume.pdf", fun_fact: 'I once swam with sharks'}
  ]
